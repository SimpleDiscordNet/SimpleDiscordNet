...
/// <summary>
/// Enterprise-grade rate limiter with bucket management, global limiting, and request queuing.
/// Ensures no messages are lost while respecting Discord's rate limits.
/// </summary>
internal sealed class EnterpriseRateLimiter
{
    ...
    public EnterpriseRateLimiter(TimeProvider? timeProvider = null)
    {
...
public sealed class RateLimitHandle : IDisposable
{
    ...
    private readonly EnterpriseRateLimiter _limiter;

    internal RateLimitHandle(RateLimitBucket bucket, IDisposable bucketLease, EnterpriseRateLimiter limiter)
    {
        _bucket = bucket;
