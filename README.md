...
**📖 Full documentation is available in the [Wiki](https://github.com/YourUsername/SimpleDiscordNet/wiki)**

- [Installation](https://github.com/YourUsername/SimpleDiscordNet/wiki/Installation) - Get started with NuGet or source reference
- [Getting Started](https://github.com/YourUsername/SimpleDiscordNet/wiki/Getting-Started) - Your first bot in minutes
- [Configuration](https://github.com/YourUsername/SimpleDiscordNet/wiki/Configuration) - Builder patterns, DI, intents
- [Commands](https://github.com/YourUsername/SimpleDiscordNet/wiki/Commands) - Slash commands, components, modals
- [Events](https://github.com/YourUsername/SimpleDiscordNet/wiki/Events) - Gateway events and logging
- [API Reference](https://github.com/YourUsername/SimpleDiscordNet/wiki/API-Reference) - Complete API documentation
- [Rate Limit Monitoring](https://github.com/YourUsername/SimpleDiscordNet/wiki/Rate-Limit-Monitoring) - Advanced monitoring and analytics
- [FAQ](https://github.com/YourUsername/SimpleDiscordNet/wiki/FAQ) - Common questions and troubleshooting
...
**Ready to build your Discord bot?** Head to the [Wiki](https://github.com/YourUsername/SimpleDiscordNet/wiki) to get started!
